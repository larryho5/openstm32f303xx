...
typedef struct
{
  __IO uint32_t MODER;        /*!< GPIO port mode register,                                  Address offset: 0x00 */ // GPIOE->MODER  0x48001000
  __IO uint16_t OTYPER;       /*!< GPIO port output type register,                           Address offset: 0x04 */ // GPIOE->OTYPER 0x48001004
